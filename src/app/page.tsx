...
const LandingComparisonSlider: React.FC<{ 
  ...
  return (
    <div 
      className="relative w-full h-64 border border-zinc-800 rounded-lg overflow-hidden bg-zinc-900 shadow-sm select-none cursor-col-resize"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl font-normal tracking-tight mb-6 leading-tight">
                  Professional product photography.
                  <br />
                  <span className="text-zinc-500">No studio required.</span>
                </h1>
                <p className="text-lg text-zinc-400 mb-8 max-w-xl font-normal leading-relaxed">
                ...
                <div className="flex items-center gap-4 mb-12">
                  <Link
                    href="/auth"
                    className="px-6 py-2.5 bg-white text-black text-sm font-medium hover:bg-zinc-100 transition-colors"
                  >
                    Start Free Trial
                  </Link>
                  <button 
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-12">
                <div className="space-y-4">
                  ...
                  <h3 className="text-lg font-medium">Upload your product</h3>
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-lg font-medium">Download & use</h3>
                  <p className="text-zinc-400 text-sm leading-relaxed">
            ...
            >
              ...
              <p className="text-zinc-500 mb-12 text-xs">💡 Drag the slider on any image to see the before/after comparison</p>
              ...
              <div className="space-y-16">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-xl font-medium mb-2">E-commerce Photography</h3>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="md:order-1 space-y-6">
                    <div>
                      <h3 className="text-xl font-medium mb-2">Lifestyle Photography</h3>
                      <p className="text-zinc-400 text-sm leading-relaxed mb-4">
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="border border-zinc-700 p-6 space-y-4">
                  <div>
                    <h3 className="text-lg font-medium text-white">Pro Weekly</h3>
                    <div className="text-2xl font-medium text-white mt-2">$7</div>
                ...
                <div className="border border-white p-6 space-y-4">
                  <div>
                    <h3 className="text-lg font-medium text-white">Pro Monthly</h3>
                    <div className="text-2xl font-medium text-white mt-2">$20</div>
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-zinc-400 mb-6 max-w-xl mx-auto font-light">
          ...
          <motion.div
            ...
            className="border border-zinc-800 rounded-lg p-6 mb-8"
          >
            ...
            <div className="flex justify-center mt-8">
              <motion.button
                ...
                className={`px-6 py-2 rounded font-light transition-all duration-200 ${
