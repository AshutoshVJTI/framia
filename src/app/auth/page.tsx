        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white text-black rounded font-light hover:bg-zinc-100 transition-colors cursor-pointer"
            >
